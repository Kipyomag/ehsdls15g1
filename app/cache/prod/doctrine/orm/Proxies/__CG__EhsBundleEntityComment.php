 ...
 */
class Comment extends \EhsBundle\Entity\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EhsBundle\\Entity\\Comment' . "\0" . 'id', '' . "\0" . 'EhsBundle\\Entity\\Comment' . "\0" . 'content', '' . "\0" . 'EhsBundle\\Entity\\Comment' . "\0" . 'creationDate', '' . "\0" . 'EhsBundle\\Entity\\Comment' . "\0" . 'author', '' . "\0" . 'EhsBundle\\Entity\\Comment' . "\0" . 'article'];
        }
